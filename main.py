...
class Main(tk.Frame):
    ...
    def view_records(self):
        # выбираем информацию из базы данных
        self.db.c.execute('''SELECT * FROM db''')
        # удаляем все из виджета таблицы
        [self.tree.delete(i) for i in self.tree.get_children()]
        # добавляем в виджет таблицы всю информацию из базы данных
...
class Database:
    def __init__(self):
        ...
        # создание объекта класса курсор, используемый для взаимодействия с базой данных
